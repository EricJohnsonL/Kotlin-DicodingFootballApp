...
import com.ericjohnson.footballapps.adapter.recyclerviewadapter.FavoriteMatchAdapter
...
class FavoriteMatchFragment : Fragment(), FavoriteMatchView, AnkoComponent<Context> {
    ...
    private val favoriteMatchPresenter: IFavoriteMatchPresenter<FavoriteMatchView> =
